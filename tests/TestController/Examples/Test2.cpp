...
public:
    ...
    Test2()
        : TestBase(_T("Test 2 description"))
    {
...
static QualityAssurance::ITestController::ITest* _singleton(Core::ServiceType<Test2>::Create<QualityAssurance::ITestController::ITest>());
} // namespace Thunder
