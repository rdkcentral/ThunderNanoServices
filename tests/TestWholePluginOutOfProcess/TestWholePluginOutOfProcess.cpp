...
namespace Plugin {
    ...
    namespace {
        ...
        static Metadata<TestWholePluginOutOfProcess> metadata(
        // Version
        1, 0, 0,
        // Preconditions
        {},
    ...
    const string TestWholePluginOutOfProcess::Initialize(VARIABLE_IS_NOT_USED PluginHost::IShell* service) {
        string message;
