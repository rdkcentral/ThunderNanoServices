...
This document describes purpose and functionality of the ScriptEngine plugin. It includes detailed specification about its configuration, methods and properties as well as sent notifications.
...
The following methods are provided by the ScriptEngine plugin:
...
```json
{
  "jsonrpc": "2.0",
  "id": 42,
  "method": "ScriptEngine.1.versions"
}
```
...
This method will return *True* for the following methods/properties: *url, versions, exists, register, unregister*.
...
This method supports the following event names: *[urlchanged](#notification_urlchanged)*.
...
```json
{
  "jsonrpc": "2.0",
  "id": 42,
  "method": "ScriptEngine.1.unregister",
  "params": {
    "event": "urlchanged",
    "id": "myapp"
  }
