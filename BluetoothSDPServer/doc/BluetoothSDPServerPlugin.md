...
This document describes purpose and functionality of the BluetoothSDPServer plugin. It includes detailed specification about its configuration and methods provided.
...
The following methods are provided by the BluetoothSDPServer plugin:
...
```json
{
  "jsonrpc": "2.0",
  "id": 42,
  "method": "BluetoothSDPServer.1.versions"
}
```
...
```json
{
  "jsonrpc": "2.0",
  "id": 42,
  "method": "BluetoothSDPServer.1.exists",
  "params": {
    "method": "versions"
  }
}
