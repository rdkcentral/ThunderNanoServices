...
```json
{
  "jsonrpc": "2.0",
  "id": 42,
  "method": "SubsystemControl.1.versions"
}
```
...
This method will return *True* for the following methods/properties: *versions, exists, activate*.
...
```json
{
  "jsonrpc": "2.0",
  "id": 42,
  "method": "SubsystemControl.1.exists",
  "params": {
    "method": "versions"
  }
}
