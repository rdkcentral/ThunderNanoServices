...
typedef enum cec_adapter_role {
    HDMI_CEC_ADAPTER_DEVICE_TV = 0x01,
    HDMI_CEC_ADAPTER_DEVICE_RECORDER = 0x02,
    HDMI_CEC_ADAPTER_DEVICE_TUNER = 0x04,
    HDMI_CEC_ADAPTER_DEVICE_PLAYBACK = 0x08,
    HDMI_CEC_ADAPTER_DEVICE_AUDIOSYSTEM = 0x10,
    HDMI_CEC_ADAPTER_DEVICE_SWITCH = 0x20,
    HDMI_CEC_ADAPTER_DEVICE_VIDEOPROCESSOR = 0x40,
    /* Reserved */
    HDMI_CEC_ADAPTER_DEVICE_UNKNOWN = 0x00,
    HDMI_CEC_ADAPTER_DEVICE_INTERNAL = 0xFD,
    HDMI_CEC_ADAPTER_DEVICE_ALL = 0x7F,
} cec_adapter_role_t;
