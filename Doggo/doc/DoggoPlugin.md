...
| Method | Description |
| :-------- | :-------- |
| [touch](#method_touch) | Touch the watchdog as a sign of life |
...
This method will return *True* for the following methods/properties: *versions, exists, touch*.
...
<a id="method_touch"></a>
## *touch [<sup>method</sup>](#head_Methods)*
