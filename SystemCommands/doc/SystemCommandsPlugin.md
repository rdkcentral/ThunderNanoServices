...
<a id="head_System_Commands_Plugin"></a>
...
| Method | Description |
| :-------- | :-------- |
| [usbreset](#method_usbreset) | Resets a USB device |
...
```json
{
  "jsonrpc": "2.0",
  "id": 42,
  "method": "SystemCommands.1.versions"
}
```
...
This method will return *True* for the following methods/properties: *versions, exists, usbreset*.
...
```json
{
  "jsonrpc": "2.0",
  "id": 42,
  "method": "SystemCommands.1.exists",
  "params": {
    "method": "versions"
  }
}
...
<a id="method_usbreset"></a>
## *usbreset [<sup>method</sup>](#head_Methods)*
