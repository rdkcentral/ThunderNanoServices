...
#include "CommunicationPerformanceCOMRPCServer.h"
...
static Metadata<CommunicationPerformanceCOMRPCServer> metadata (
    // Version
    1, 0, 0,
    // Preconditions
    {},
...
std::string CommunicationPerformanceCOMRPCServer::Classname() const
{
