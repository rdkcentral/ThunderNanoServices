...
ENUM_CONVERSION_BEGIN(DSResolutionHAL::PixelResolution)
    { DSResolutionHAL::PixelResolution_720x480,    _TXT("720x480")  },
...
const DSResolutionHAL::PixelResolution DSResolutionHAL::Resolution()
{
    ...
    if (dsGetResolution(_vopHandle,&resolution) == dsERR_NONE) {
        ...
        const auto index = std::find_if(pixelFormatLookup.cbegin(), pixelFormatLookup.cend(),
                      [format](const std::pair<const DSResolutionHAL::PixelResolution, const dsVideoResolution_t>& found)
