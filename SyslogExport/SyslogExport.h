...
namespace Plugin {
    ...
    public:
        ...
        INTERFACE_ENTRY(PluginHost::ITextSocket)
        END_INTERFACE_MAP
    ...
    public:
        ...
        //! @}
        string Inbound(const uint32_t ID, const string& value) override;
